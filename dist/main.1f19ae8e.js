...
var HOME_PLATE_X = 288.9642;
var HOME_PLATE_Y = 589.1899; // 248.0316
...
var MidRightCenterField = {
  x: 237.2536,
  y: 193.1899
};
var RightCenterField = {
  x: 426.1875,
  y: 193.1899
};
var MidRightField = {
...
function draw() {
  ...
  if (canvas.getContext) {
    var ctx = canvas.getContext("2d"); // Cubic curves example

    ctx.beginPath();
    ctx.moveTo(HOME_PLATE_X, HOME_PLATE_Y); // RF
    ...
    ctx.lineTo(LeftField.x, LeftField.y); // ctx.lineTo(MidRightCenterField.x, MidRightCenterField.y);
    // ctx.lineTo(MidRightCenterField.x, MidRightCenterField.y);
